...
Organizations report aid activities in compliance with IATI by converting activity information into machine readable XML code. Then organizations file and publish the information on their web servers and send file metadata to the [IATI Registry](https://www.iatiregistry.org/) (Here's an [XML file](http://iati.oxfam.org.uk/xml/oxfamgb-al.xml) published by [Oxfam GB](https://www.oxfam.org.uk/) containing information on 9 aid activities in Albania).
